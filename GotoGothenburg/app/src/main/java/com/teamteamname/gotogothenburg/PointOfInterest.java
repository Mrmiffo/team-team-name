...
public enum PointOfInterest {
    ...
    CHALMERS_CAMPUS_JOHANNEBERG(new GPSCoord(57.689167f, 11.973611f),
            new File("src/main/res/guide/" + "chalmerscampusjohannebergtestimage.txt"),
            new File("src/main/res/guide/" +  "chalmerscampusjohannebergtestimage.mp3"),
            new File("src/main/res/guide/" + "chalmerscampusjohannebergtestimageimage.jpg")),
    ...
    private static String guideDir = "src/main/res/guide/";
