...
/**
 * The destination class containing a location, name, and a boolean for if it has been
...
public final class Destination{
    ...
    @Getter final private double latitude;
    @Getter final private double longitude;
